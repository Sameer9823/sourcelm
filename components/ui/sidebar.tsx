...
function SidebarMenuSkeleton({
  ...
  // Deterministic "random-looking" width derived from useId, which React
  // guarantees is identical between the server render and the client's
  // first render. Math.random() (the previous implementation) produces a
  // different value on each call, so the server and client widths never
  // matched — causing a hydration mismatch on every page load.
