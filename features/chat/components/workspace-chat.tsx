...
export function WorkspaceChat({
    ...
    useEffect(() => {
        ...
        // eslint-disable-next-line react-hooks/set-state-in-effect
        setCitationsByMessageId((_) => buildCitationMap(storedMessages));
    }, [conversationId, storedMessages, isStreaming]);
    ...
    useEffect(() => {
        ...
        // Use functional update to avoid setState in effect lint warning
        // eslint-disable-next-line react-hooks/set-state-in-effect
        setCitationsByMessageId((_prev) => buildCitationMap(storedMessages));
