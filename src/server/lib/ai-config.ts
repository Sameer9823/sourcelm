...
/** Text-to-speech model used for podcast voice synthesis (OpenAI voice agent). */
export const TTS_MODEL = "gpt-4o-mini-tts";

/** The two-host podcast persona voices, mapped to OpenAI's built-in TTS voices. */
export const PODCAST_VOICES = {
    HOST_A: "alloy",
    HOST_B: "echo",
} as const;

/** Average spoken words per minute, used to estimate segment/episode duration. */
export const WORDS_PER_MINUTE = 160;

/** Hard cap on script segments so an episode stays a reasonable length. */
export const MAX_PODCAST_SEGMENTS = 40;
