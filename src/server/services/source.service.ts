...
export async function createTextOrMarkdownSource(
    ...
    await spendCredits({
        ...
        description: `Added source: ${input.title}`,
    });
...
export async function uploadPdfSource(
    ...
    await spendCredits({
        userId,
        action: "SOURCE_INGEST",
        description: `Uploaded PDF: ${title || file.originalname}`,
    });
...
export async function importWebsiteSource(
    ...
    await spendCredits({
        userId,
        action: "SOURCE_INGEST",
        description: `Imported website: ${input.url}`,
    });
...
export async function importYoutubeSource(
    ...
    await spendCredits({
        userId,
        action: "SOURCE_INGEST",
        description: `Imported YouTube: ${input.url}`,
    });
...
export async function importWebSearchSource(
    ...
    await spendCredits({
        userId,
        action: "SOURCE_INGEST",
        description: `Saved web result: ${input.title}`,
    });
